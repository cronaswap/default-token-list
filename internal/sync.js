...
const { ChainId } = require("@cronaswap/core-sdk");
  ...
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("cronaswap/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/cronaswap/icons/master/token/${icon}.jpg`;
